...
<head>
    ...
    <link rel="shortcut icon" href="/litejia-home-1.0.0-SNAPSHOT/img/icon.png" type="image/x-icon">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <link href="/litejia-home-1.0.0-SNAPSHOT/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="/litejia-home-1.0.0-SNAPSHOT/css/main.css" rel="stylesheet" media="screen">
    <link href="/litejia-home-1.0.0-SNAPSHOT/css/home.css" rel="stylesheet" media="screen">
    <link rel="stylesheet" href="/litejia-home-1.0.0-SNAPSHOT/css/media.css"/>
    <link href="/litejia-home-1.0.0-SNAPSHOT/css/video-loop.css" rel="stylesheet" media="screen">
    <link href="/litejia-home-1.0.0-SNAPSHOT/css/jquery.fullPage.css" rel="stylesheet" media="screen">
    <script type="text/javascript" src="/litejia-home-1.0.0-SNAPSHOT/js/jquery-1.12.0.min.js"></script>
    <script type="text/javascript" src="/litejia-home-1.0.0-SNAPSHOT/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/litejia-home-1.0.0-SNAPSHOT/js/video-loop.js"></script>
    <script type="text/javascript" src="/litejia-home-1.0.0-SNAPSHOT/js/menu.js"></script>
    <script type="text/javascript" src="/litejia-home-1.0.0-SNAPSHOT/js/scrollToggle.js"></script>
